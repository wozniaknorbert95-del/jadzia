...
from agent.publishers.facebook import publish_photo, publish_post


def publish_calendar_content(row: Dict) -> dict:
    """Route publish to text or photo endpoint."""
    ...
    if content_type == "video":
        return {
            "status": "error",
            "error": "Video publish (M2) — zapisz wpis, publikacja wideo w następnej fazie",
        }
