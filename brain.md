...
- **Active plan:** `docs/handoffs/2026-07-18-rev-demand-02a-CLOSE.md` — **02a** CTA hotfix code+tests ready (await GO redeploy); VPS still `3746f9e`; then **02** durability; parks preserved
