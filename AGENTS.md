...
- **Active program**: REV-DEMAND **F0–F7** program CLOSED; phone hub **COI-CMD-MOBILE-01** LIVE (FEATURE UI `87d7912`)
- **Active plan / gate**: `todo.json` → `active_gate` = `NONE` (await next GO; no invented F8)
- **Latest handoff**: `docs/handoffs/2026-07-18-rev-demand-PROGRAM-CLOSE.md`
