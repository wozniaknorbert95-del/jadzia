...
- **Active program**: REV-DEMAND next **04**; phone hub **COI-CMD-MOBILE-01** LIVE tip `debed13` (feature `87d7912`)
...
- **Current prod state**: Jadzia VPS **`master` tip `debed13`** (mobile hub FEATURE `87d7912` + Demand-03 FEATURE `367549f`); producer theme `@ bfe8485`; Gate C PASS (#3209); COD OFF; iDEAL-only; Mollie TEST; **Gate D parked**; min 199 unchanged.
