...
**Date:** 2026-07-18  
**Repo:** jadzia-core  
**TIP_SHA:** `debed13` (docs tip; FEATURE UI `87d7912`)  
**VPS:** `/opt/jadzia` @ `debed13`, `jadzia.service` **active**  
...
| Tip | FEATURE `87d7912` + docs tip `debed13` |
...
```text
STATE: SSoT clean; COI-CMD-MOBILE-01 LIVE tip debed13 (feature 87d7912); Demand 01-03 evidence PASS
...
DEPLOY_STATE: Jadzia master debed13 active
```
