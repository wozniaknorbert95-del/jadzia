...
**Date:** 2026-07-18  
**Repo:** jadzia-core  
**TIP_SHA:** `735c2b4` (docs tip; FEATURE UI `87d7912`)  
**VPS:** `/opt/jadzia` @ `735c2b4`, `jadzia.service` **active**  
...
| Tip | FEATURE `87d7912` + docs tip `735c2b4` |
...
```text
STATE: SSoT clean; COI-CMD-MOBILE-01 LIVE tip 735c2b4 (feature 87d7912); Demand 01-03 evidence PASS
...
DEPLOY_STATE: Jadzia master 735c2b4 active
```
