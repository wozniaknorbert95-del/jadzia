...
| **VHQ-DI scorecard** | Decision Instrument S1–S6+S8 = **5 DONE** · S7 parked — SoT `docs/ops/VHQ-DECISION-INSTRUMENT-SCORECARD.md` · lanes `docs/ops/PROGRAM-LANES-SOT.md` · next = Growth (not S7) | program | DI closeout tip `0264f5d` |
