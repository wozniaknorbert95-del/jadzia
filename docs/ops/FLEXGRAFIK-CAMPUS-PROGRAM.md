...
| EV-CAMPUS-002 | Commander `?cb=desk-dash05` | prod | URL 200 + cache `desk-dash05` · default Desk | 2026-08-02 | 24h | Ops/COI | **verified @ 5d** |
...
source_of_truth:
  ...
  url: https://api.zzpackage.flexgrafik.nl/commander/?cb=desk-dash05
primary_action:
  label: Biuro Popytu — operacja dnia
  target: https://api.zzpackage.flexgrafik.nl/commander/?cb=desk-dash05
room_card:
...
|--------|--------|-------|--------|-----------------|-------------|---------|
| HOP-CMD | Home map | Biuro Popytu | `/commander/?cb=desk-dash05` | `desk-dash05` in HTML | 200 JWT session | EV-002 verified |
