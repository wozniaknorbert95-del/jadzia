...
| 4 | AI Marketing | Hub §M · tool+ops sealed · later HITL | Demand OS Hub + status | TOOL+OPS SEALED / live_cadence PARKED | `OPS-HARDENING-SEAL` · `UNLOCK-LIVE-P0.md` | Dowódca unlock before live P0 |
